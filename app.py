...
# Entrada: Caminho do banco de dados
# Saída: Conexão com o banco de dados via SQLAlchemy
# Observação: Pode ser alterado para PostgreSQL em produção
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///todolist_test.db'
